...
function search() {
    //original is pac-input2 change for automatic fill
...
function initAutocomplete() {
    ...
    searchBox.addListener("places_changed", () => {
        ...
        //original is pac-input2 change for automatic fill
        var customerAddress = document.getElementById('pac-input').value;
        document.getElementById('pac-input2').value = customerAddress;
    });
}
